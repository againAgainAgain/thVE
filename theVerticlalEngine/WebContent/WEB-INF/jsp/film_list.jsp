...
<script type="text/javascript">
	...
	function filter(key, value) {
		...
		document.getElementById("id_height").value=value;
		//执行查询
		queryList();
	}
	function sort(){
	...
	<div class="container">
    				...
    				<div class="row">
    					<div class="col-lg-10">
                  			<div class="input-group">
                    			...
                    			<!-- 下面的hidden要写在query()前面，才能保证再次搜索时能够清空筛选条件 -->
    							...
    							<input type="hidden" name="id_height" id="id_height" value="${id_height}"/>
		...
		<div style="height:100px;overflow:visible;">
          <ul class="nav nav-tabs" >
            ...
            <li class="dropdown">
              <a id="change_score" class="dropdown-toggle" data-toggle="dropdown" href="#">
                评分区间 <span class="caret"></span>
              </a>
              <ul class="dropdown-menu">
              	<li><a id="0-10" href="javascript:filter('score','0-10')">全部评分</a></li>
              	<li><a id="9.5-10" href="javascript:filter('score','9.5-10')">9.5-10</a></li>
                <li><a id="9-9.5" href="javascript:filter('score','9-9.5')">9-9.5</a></li>
                <li><a id="0-9" href="javascript:filter('score','0-9')">9分以下</a></li>
              </ul>
            </li>
          </ul>
...
<!--商品列表结束-->
	<div>
		...
		<c:forEach var="x" begin="1" end="${num}" step="1">
			<a id="${x}" href="javascript:filter('page','${x}')" style="display:block;width:50px;float:left;text-align:center">第 ${x}页</a>
		</c:forEach>
	</div>
	</div>
	...
	<script>
		...
		if(score!=null && score!="")
			document.getElementById("change_score").innerHTML=score+"<span class='caret'></span>";
	</script>
